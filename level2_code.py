...
def show_gif(gif_name, duration):
    global gif_running
    gif_running = False
    gif_running = True
    ...
    if ser.in_waiting:
        ...
        if uid == animal_to_uid[current_animal]:
            ...
            if retry_count < MAX_RETRIES:
                ...
                root.after(1500, lambda: show_next_animal())
            else:
